...
namespace MolaApp.ImageCrop
{
    [DLToolkit.Forms.Controls.Helpers.ImageCropView.Preserve(AllMembers = true)]
    public class MolaCropView : ContentView
    {
        /// <summary>
...
#pragma warning disable 0219
            var dummy1 = typeof(MolaCropView);
#pragma warning restore 0219
        ...
        public event EventHandler SetSourceFinished;
        private void NotifySetSourceFinished()
        {
            SetSourceFinished?.Invoke(this, null);
        }
        ...
        public static readonly BindableProperty TransformationsProperty = BindableProperty.Create(nameof(Transformations), typeof(IList<ITransformation>), typeof(MolaCropView), new List<ITransformation>());
        ...
        public static readonly BindableProperty PreviewTransformationsProperty = BindableProperty.Create(nameof(PreviewTransformations), typeof(IList<ITransformation>), typeof(MolaCropView), new ObservableCollection<ITransformation>(), propertyChanged: (bindable, oldValue, newValue) =>
        {
            ((MolaCropView)bindable).HandlePreviewTransformations(oldValue, newValue);
        });
        ...
        public static readonly BindableProperty SourceProperty = BindableProperty.Create(nameof(Source), typeof(ImageSource), typeof(MolaCropView), default(ImageSource));
        ...
        public static readonly BindableProperty FrameViewProperty = BindableProperty.Create(nameof(FrameView), typeof(View), typeof(MolaCropView), default(View));
        ...
        public static readonly BindableProperty PanSpeedProperty = BindableProperty.Create(nameof(PanSpeed), typeof(double), typeof(MolaCropView), 1d);
        ...
        public static readonly BindableProperty ZoomSpeedProperty = BindableProperty.Create(nameof(ZoomSpeed), typeof(double), typeof(MolaCropView), 1d);
        ...
        public static readonly BindableProperty ManualZoomProperty = BindableProperty.Create(nameof(ManualZoom), typeof(double), typeof(MolaCropView), 1d);
        ...
        public static readonly BindableProperty ManualOffsetXProperty = BindableProperty.Create(nameof(ManualOffsetX), typeof(double), typeof(MolaCropView), default(double));
        ...
        public static readonly BindableProperty ManualOffsetYProperty = BindableProperty.Create(nameof(ManualOffsetY), typeof(double), typeof(MolaCropView), default(double));
        ...
        public static readonly BindableProperty DelayProperty = BindableProperty.Create(nameof(Delay), typeof(int), typeof(MolaCropView), 100);
        ...
        public static readonly BindableProperty PreviewMaxResolutionProperty = BindableProperty.Create(nameof(PreviewMaxResolution), typeof(int), typeof(MolaCropView), default(int));
        ...
        public static readonly BindableProperty RefinedMaxResolutionProperty = BindableProperty.Create(nameof(RefinedMaxResolution), typeof(int), typeof(MolaCropView), default(int));
        ...
        public static readonly BindableProperty MaxZoomProperty = BindableProperty.Create(nameof(MaxZoom), typeof(double), typeof(MolaCropView), 4d);
        ...
        public static readonly BindableProperty TouchGesturesEnabledProperty = BindableProperty.Create(nameof(TouchGesturesEnabled), typeof(bool), typeof(MolaCropView), true);
        ...
        public static readonly BindableProperty ImageRotationProperty = BindableProperty.Create(nameof(ImageRotation), typeof(int), typeof(MolaCropView), default(int));
        ...
        protected override async void OnPropertyChanged(string propertyName = null)
        {
            ...
            {
                ResetCrop();
                await _image.SetSource(Source);
                NotifySetSourceFinished();
            }
        ...
        class CustomCachedImage : CachedImage
        {
            ...
            public async Task SetSource(ImageSource source)
            {
                try
                {
